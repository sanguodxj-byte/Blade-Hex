...
public partial class HexOverworldGrid : RefCounted
{
    ...
    private static int HexTerrainToOverworld(HexOverworldTile.TerrainType hexTerrain) => hexTerrain switch
    {
        ...
        HexOverworldTile.TerrainType.Bog => 3,
        HexOverworldTile.TerrainType.Swamp => 3,
        HexOverworldTile.TerrainType.Savanna => 0,
        HexOverworldTile.TerrainType.Wasteland => 6,
        HexOverworldTile.TerrainType.Rocky => 2,
        HexOverworldTile.TerrainType.Hills => 2,
        HexOverworldTile.TerrainType.Mountain => 2,
        HexOverworldTile.TerrainType.MountainSnow => 2,
        HexOverworldTile.TerrainType.Snow => 0, // treating flat snow as plain for speed map
        HexOverworldTile.TerrainType.Ice => 4,  // treating ice as water for speed map
