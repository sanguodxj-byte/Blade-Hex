// SaveManagerV2.cs — 统一存档管理器（JSON 格式）
// 替代 V1 (SaveManager.cs) 的二进制 StoreVar 格式
// 特性：JSON 可读、自动备份、V1 旧存档兼容读取
using Godot;
using System;
...
/// </summary>
[GlobalClass]
public partial class SaveManagerV2 : Node
{
    ...
    /// <summary>从 OverworldScene 运行时状态构建完整存档数据</summary>
