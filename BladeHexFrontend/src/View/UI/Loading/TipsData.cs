...
public partial class TipsData : RefCounted
{
    ...
    private void LoadHardcodedTips()
    {
        ...
        _tips.Add(new Tip("combat_7", "战场上最致命的武器不是刀剑，而是预判。观察行动顺序，提前将盾牌朝向正确的方向，胜利往往取决于比敌人多想一步。", "combat", 2));
        _tips.Add(new Tip("combat_8", "老练的法师知道：最好的法术不是伤害最高的，而是能改变战场本身的。点燃草地、冻结河流、掀起迷雾——让地形成为你的盟友。", "combat", 4));
        _tips.Add(new Tip("combat_9", "后排的弓箭手看似安全，但一旦被骑兵或刺客贴身，他们将毫无还手之力。永远不要让远程单位孤军奋战。", "combat", 3));
        _tips.Add(new Tip("combat_10", "一个站在原地不动的战士，很快就会变成一个躺在地上不动的战士。保持移动，利用掩体，让敌人追逐你的影子。", "combat", 3));
        ...
        _tips.Add(new Tip("explore_3", "城镇是冒险者的港湾：铁匠修复破损的装备，酒馆交换最新的情报，佣兵公会则随时有等着你的人手——只要你付得起价钱。", "exploration", 3));
        _tips.Add(new Tip("explore_4", "当太阳沉入地平线，荒野便不再属于旅人。夜行军不仅速度更慢，伏击的概率也会翻倍。如果必须在夜间赶路，至少派斥候先行。", "exploration", 4));
        _tips.Add(new Tip("explore_5", "某些遗迹的入口被古老的机关封锁，需要特定的技能才能开启。如果暂时进不去，记下位置——终有一天你会具备开启它的能力。", "exploration", 3));
        _tips.Add(new Tip("explore_6", "路边的旅人和流浪商人往往掌握着地图上找不到的信息。停下来聊几句，也许能省去数日的弯路。", "exploration", 2));
        ...
        _tips.Add(new Tip("skill_2", "即便最长寿的精灵穷尽一生，也只能点亮技能盘上不到三分之一的星辰。\"全都要\"从来不是一个选项——取舍，才是真正的游戏。", "skill", 5));
        _tips.Add(new Tip("skill_3", "跳跃是穿越技能盘的捷径，能让你瞬间抵达远处的节点，跳过漫长的路径——但这种力量一生只有四次。用在哪，决定了你是谁。", "skill", 4));
        _tips.Add(new Tip("skill_4", "代价型大节点散发着诱人的光芒，承诺着远超寻常的力量。但仔细阅读代价——有些东西一旦失去，就再也回不来了。", "skill", 4));
        _tips.Add(new Tip("skill_5", "技能盘的六大区域并非彼此隔绝的孤岛。区域交界处的过渡节点是通往新方向的桥梁，只需付出不多的代价便能涉足新的领域。", "skill", 3));
        _tips.Add(new Tip("skill_6", "六芒星的六个顶点各代表一种力量：力量(STR)、灵巧(DEX)、体魄(CON)、智力(INT)、感知(WIS)、魅力(CHA)。你的旅途从中心启程，方向由你决定。", "skill", 2));
        _tips.Add(new Tip("skill_7", "通往同一个大节点的路径不止一条。左路经过火焰，右路经过坚冰——殊途同归，但沿途的收获截然不同。仔细观察，选一条最契合你的路。", "skill", 3));
        _tips.Add(new Tip("skill_8", "纯方向build和混合build都是可行的道路。专注一个方向能抵达该领域的巅峰，而跨领域探索虽然无法登顶，却能获得意想不到的化学反应。", "skill", 3));
        
        // ============ 角色提示 ============
        _tips.Add(new Tip("char_1", "种族不只是外表的差异。矮人天生坚韧，精灵感知敏锐，半兽人体魄强健——你的血脉会为冒险的起点染上第一抹底色。", "character", 2));
        _tips.Add(new Tip("char_2", "经验值是冒险的副产物——战斗、探索、完成委托，每一次经历都在塑造你的角色。当你感到自己变强时，技能点已在口袋中等待分配。", "character", 3));
        _tips.Add(new Tip("char_3", "武器决定你如何战斗，护甲决定你能承受多少，饰品则往往藏着扭转战局的奇效。三个装备槽位，三种截然不同的策略取向。", "character", 2));
        _tips.Add(new Tip("char_4", "职业称号不过是世人对你的称呼——\"魔剑士\"或\"圣骑士\"只取决于你在技能盘上的足迹。称号不会限制你的能力，它只是在描述你已经成为的那个人。", "character", 3));
        _tips.Add(new Tip("char_5", "属性修正值看似微小，但在骰子落下的那一刻，+1与-1之间的差距，往往就是成功与失败的边界。", "character", 4));
        
        // ============ 故事提示 ============
        _tips.Add(new Tip("story_1", "六芒星是这个世界最古老的力量象征。传说在第一纪元的末日之战中，六芒星的力量将整块大陆撕裂成了今天的模样。", "story", 1));
        _tips.Add(new Tip("story_2", "大陆上流传着一个关于\"无冕者\"的传说——一个没有种族、没有出身、没有命运的旅人，据说他至今仍在某处流浪。", "story", 1));
        _tips.Add(new Tip("story_3", "精灵记住了所有的历史，矮人建造了不灭的城池，人类则在废墟上不断重建——每个种族都有自己面对过去的方式。", "story", 1));
        _tips.Add(new Tip("story_4", "在某些偏远村庄的酒馆里，老人会在深夜压低声音讲述关于\"第七芒\"的传说。大多数听众只当那是醉话，但知情者会选择沉默。", "story", 2));
        ...
        _tips.Add(new Tip("general_2", "右键点击任何单位可以查看它的详细信息——属性、装备、技能，甚至隐藏的弱点。知己知彼，方能百战不殆。", "general", 2));
