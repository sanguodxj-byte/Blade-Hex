...
internal static class PoiTownAdapter
{
    ...
    public static bool OpensTownPanelDirectly(OverworldPOI.POIType poiType) => poiType switch
    {
        ...
        OverworldPOI.POIType.Mine => true,
        OverworldPOI.POIType.Farm => true,
        _ => false,
    };

    private static void ApplyFacilities(OverworldTown town, OverworldPOI poi)
    {
