...
public partial class MinimapController : Node
{
    ...
    public bool Initialize(FogOfWar? fog, ChunkManager? chunkManager, List<OverworldPOI> worldPois, OverworldCamera3D camera)
    {
        if (fog == null)
        {
    ...
    public void Tick(Vector2 playerPixelPos)
    {
        ...
        _panel.UpdatePlayerAndCamera(playerPixelPos, playerPixelPos, fakeZoom, viewportSize);
    }
