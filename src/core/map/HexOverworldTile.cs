...
// 迁移自 GDScript HexOverworldTile.gd
using Godot;
using System;
...
/// </summary>
[GlobalClass]
public partial class HexOverworldTile : RefCounted
{
    // ========================================
    // 地形类型枚举
    // ========================================
    ...
    /// <summary>地形纹理根目录</summary>
    public const string TextureBasePath = "res://src/assets/tiles/hex_terrain";
    ...
    public void UpdateTerrainProperties()
    {
        (IsPassable, MoveCost) = Terrain switch
        {
            ...
            TerrainType.Road => (true, 0.5f),
            TerrainType.River => (false, 99.0f),
            // 未在原始 match 中列出的地形保持默认值 (is_passable=true, move_cost=1.0)
            _ => (true, 1.0f),
        };
    }
    ...
    /// <summary>获取地形纹理文件名前缀</summary>
    public static string TerrainTextureName(TerrainType t) => t switch
    {
        TerrainType.DeepWater => "pond",
        TerrainType.ShallowWater => "pond",
        TerrainType.Sand => "wasteland",
        TerrainType.Plains => "grassland",
        TerrainType.Grassland => "grassland",
        TerrainType.Forest => "forest",
        TerrainType.DenseForest => "forest",
        TerrainType.Hills => "rocky_land",
        TerrainType.Mountain => "mountain_cave",
        TerrainType.Snow => "mountain_cave",
        TerrainType.Swamp => "swamp",
        TerrainType.Savanna => "barren_land",
        TerrainType.Road => "crossroads",
        TerrainType.River => "pond",
        _ => "grassland",
    };

    /// <summary>获取地形变体数</summary>
    public static int TerrainVariantCount(TerrainType t) => t switch
    {
        ...
        TerrainType.DenseForest => 3,
        TerrainType.Hills => 2,
        TerrainType.Mountain => 2,
        TerrainType.Snow => 2,
        TerrainType.Swamp => 3,
        TerrainType.Savanna => 2,
        TerrainType.Road => 1,
        TerrainType.River => 1,
        _ => 1,
    };
    ...
    /// <summary>获取完整地形纹理路径</summary>
    public static string GetTerrainTexturePath(TerrainType t, int variant = 0)
    {
        string name = TerrainTextureName(t);
        int maxV = Mathf.Max(TerrainVariantCount(t), 1);
        return $"{TextureBasePath}/{name}_{variant % maxV}.png";
    }
