...
// 迁移自 GDScript SkillTreeData.gd (715 lines)
using Godot;
...
public partial class SkillTreeData : RefCounted
{
    ...
    void BuildIntRegion()
    {
        ...
        n = Mk("int_ks01", "绝对专注", 8, ["int_s12"], "absolute_focus", "法术DC+4", "不能学习其他体系的法术", new Godot.Collections.Dictionary(), Mp(3,8,-3));
    ...
    void BuildWisRegion()
    {
        ...
        n = Ms("wis_s06", "神圣庇护", 3, ["wis_s09"], D(("ac", 1)), Mp(4,3,-2));
        ...
        n = Mb("wis_b04", "神圣光芒", 4, [], ["wis_s06"], "holy_light", true, "主动: 照亮黑暗区域, 亡灵受1d10伤害", Mp(4,4,-1));
        ...
        n = Mb("wis_b05", "神圣制裁", 6, [], ["wis_s07"], "divine_judgment", true, "主动: 对邪恶目标造成3d10神圣伤害", Mp(4,6,-1));
        ...
        n = Mk("wis_ks01", "神之手", 7, ["wis_s05"], "divine_hand", "治疗效果+50%", "不能造成任何伤害", D(("spell_damage", -99)), Mp(4,7,-1));
        ...
        n = Ms("wis_s12", "圣光之盾", 9, ["wis_b07"], D(("ac", 2), ("heal_amount", 1)), Mp(4,10,0));
    ...
    void BuildTransitionNodes()
    {
        SkillNodeData n;
        // STR(0) <-> DEX(1)
        n = Ms("trans_sd01", "战斗技巧", 2, ["str_s01", "dex_s01"], D(("melee_hit", 1), ("critical_rate", 0.02)), new Vector2I(2, -5));
        n.IsBridge = true;
        n = Ms("trans_sd02", "武器大师", 4, ["str_b01", "dex_b01"], D(("melee_hit", 1), ("ranged_hit", 1)), new Vector2I(5, 1));
        n.IsBridge = true;
        // STR(0) <-> CON(2)
        n = Ms("trans_sc01", "近战生存", 2, ["str_s01", "con_s01"], D(("max_hp", 3), ("melee_hit", 1)), new Vector2I(1, -5));
        n.IsBridge = true;
        n = Ms("trans_sc02", "盾牌掌握", 4, ["str_b01", "con_b01"], D(("ac", 1), ("melee_damage", 1)), new Vector2I(4, 2));
        n.IsBridge = true;
        // DEX(1) <-> INT(3)
        n = Ms("trans_di01", "精准施法", 2, ["dex_s01", "int_s01"], D(("mana_max", 2), ("spell_hit", 1)), new Vector2I(-3, -1));
        n.IsBridge = true;
        n = Ms("trans_di02", "奥术射手", 4, ["dex_b01", "int_b01"], D(("ranged_hit", 1), ("spell_damage", 1)), new Vector2I(-5, 3));
        n.IsBridge = true;
        // INT(3) <-> WIS(4)
        n = Ms("trans_iw01", "神秘学", 2, ["int_s01", "wis_s01"], D(("mana_max", 2), ("all_save", 1)), new Vector2I(4, 1));
        n.IsBridge = true;
        n = Ms("trans_iw02", "古代智慧", 4, ["int_b01", "wis_b01"], D(("spell_damage", 1), ("heal_amount", 1)), new Vector2I(-4, -2));
        n.IsBridge = true;
        // WIS(4) <-> CHA(5)
        n = Ms("trans_wc01", "精神领袖", 2, ["wis_s01", "cha_s01"], D(("heal_amount", 1), ("morale", 1)), new Vector2I(-5, -1));
        n.IsBridge = true;
        n = Ms("trans_wc02", "圣洁光辉", 4, ["wis_b01", "cha_b01"], D(("heal_amount", 1), ("ally_bonus", 1)), new Vector2I(2, -6));
        n.IsBridge = true;
        // CHA(5) <-> CON(2)
        n = Ms("trans_cc01", "鼓舞防御", 2, ["cha_s01", "con_s01"], D(("ac", 1), ("morale", 1)), new Vector2I(-1, 4));
        n.IsBridge = true;
        n.Neighbors = new List<string> { "start" };
        n = Ms("trans_cc02", "铁血指挥", 4, ["cha_b01", "con_b01"], D(("ally_bonus", 1), ("max_hp", 3)), new Vector2I(-4, 3));
        n.IsBridge = true;
        // 深层过渡
        n = Ms("trans_sd03", "剑弓合一", 7, ["str_b08", "dex_b13"], D(("melee_damage", 1), ("ranged_damage", 1), ("critical_rate", 0.02)), new Vector2I(3, 6));
        n.IsBridge = true;
        n = Ms("trans_sc03", "战神信仰", 7, ["str_b07", "cha_b10"], D(("melee_hit", 1), ("morale", 2)), new Vector2I(7, -3));
        n.IsBridge = true;
        n = Ms("trans_cw01", "生命之力", 6, ["con_b08", "wis_b08"], D(("max_hp", 8), ("heal_amount", 1)), new Vector2I(-4, -1));
        n.IsBridge = true;
        n = Ms("trans_ic01", "奥术外交", 7, ["int_b11", "cha_b11"], D(("mana_max", 3), ("cha_check", 1)), new Vector2I(-3, -2));
        n.IsBridge = true;
        n = Ms("trans_dc01", "战场机动", 6, ["dex_b11", "con_b08"], D(("ac", 1), ("initiative", 2), ("max_hp", 3)), new Vector2I(-1, 5));
        n.IsBridge = true;
        // 对角过渡
        n = Ms("trans_ci01", "战斗法师", 5, ["con_b02", "int_b08"], D(("spell_damage", 1), ("max_hp", 3)), new Vector2I(-5, 4));
        n.IsBridge = true;
        n = Ms("trans_dw01", "野性直觉", 5, ["dex_b02", "wis_b02"], D(("initiative", 2), ("wis_check", 1)), new Vector2I(1, -4));
        n.IsBridge = true;
    }
    ...
    {
        Ac("str_b02", "trans_sd02");
        Ac("dex_b02", "trans_sd02");
        Ac("con_b02", "trans_sc02");
        Ac("str_b04", "trans_sc02");
        Ac("int_b02", "trans_iw02");
        Ac("wis_b04", "trans_iw02");
        Ac("cha_b02", "trans_wc02");
        Ac("wis_b02", "trans_wc02");
        Ac("con_b04", "trans_cc02");
        Ac("cha_b04", "trans_cc02");
        Ac("str_b03", "trans_sc02");
        Ac("dex_b05", "trans_di02");
        Ac("cha_b05", "trans_wc02");
        // 内层环路
        Ac("str_s02", "trans_sd01");
        Ac("dex_s02", "trans_sd01");
        Ac("con_s02", "trans_sc01");
        Ac("str_s10", "trans_sc01");
        Ac("int_s02", "trans_iw01");
        Ac("wis_s02", "trans_iw01");
        Ac("cha_s02", "trans_wc01");
        Ac("wis_s09", "trans_wc01");
        Ac("con_s08", "trans_cc01");
        Ac("cha_s09", "trans_cc01");
        Ac("dex_s14", "trans_di01");
        Ac("int_s15", "trans_di01");
        // 前置节点也加入邻居（确保 _check_available 的邻居检查能通过）
        Ac("str_s01", "trans_sd01");
        Ac("dex_s01", "trans_sd01");
        Ac("str_s01", "trans_sc01");
        Ac("con_s01", "trans_sc01");
        Ac("dex_s01", "trans_di01");
        Ac("int_s01", "trans_di01");
        Ac("int_s01", "trans_iw01");
        Ac("wis_s01", "trans_iw01");
        Ac("wis_s01", "trans_wc01");
        Ac("cha_s01", "trans_wc01");
        Ac("cha_s01", "trans_cc01");
        Ac("con_s01", "trans_cc01");
        Ac("str_b01", "trans_sd02");
        Ac("dex_b01", "trans_sd02");
        Ac("str_b01", "trans_sc02");
        Ac("con_b01", "trans_sc02");
        Ac("dex_b01", "trans_di02");
        Ac("int_b01", "trans_di02");
        Ac("int_b01", "trans_iw02");
        Ac("wis_b01", "trans_iw02");
        Ac("wis_b01", "trans_wc02");
        Ac("cha_b01", "trans_wc02");
        Ac("cha_b01", "trans_cc02");
        Ac("con_b01", "trans_cc02");
        // 深层环路
        Ac("str_b08", "trans_sd03");
        Ac("dex_b13", "trans_sd03");
        Ac("str_b07", "trans_sc03");
        Ac("cha_b10", "trans_sc03");
        Ac("con_b08", "trans_cw01");
        Ac("wis_b08", "trans_cw01");
        Ac("int_b11", "trans_ic01");
        Ac("cha_b11", "trans_ic01");
        Ac("dex_b11", "trans_dc01");
        Ac("con_b08", "trans_dc01");
        Ac("wis_b09", "trans_cw01");
        Ac("cha_b12", "trans_sc03");
        // STR 环路: 嗜血→杀戮本能
        Ac("str_s21", "str_s19");
    }
