...
public partial class QuestData : Resource
{
    ...
    // 发布信息
    [Export] public string IssuerName = "";
    [Export] public Vector2I IssuerLocation;

    // 目标信息
    [Export] public Vector2I TargetLocation;
    [Export] public Vector2 TargetWorldPosition = Vector2.Zero;
    [Export] public string TargetDescription = "";
    ...
    [Export] public string RewardFaction = "";
