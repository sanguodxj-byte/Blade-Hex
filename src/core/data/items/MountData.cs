...
public partial class MountData : Resource
{
    ...
    [Export] public string MountName = "驮马";
    [Export] public string MountId = "";
    [Export] public int SpeedBonus = 1;
    [Export] public int MaxHp = 15;
    [Export] public int CarryCapacity = 1; // 1=中, 2=高
    [Export] public float ChargeDamageBonus = 0.25f;
    [Export] public string[] SpecialTraits = [];
    [Export] public bool CanForest = true;
    [Export] public bool CanDenseForest;
    [Export] public string[] AllowedMountedWeapons = [];
    [Export] public int Price = 20;
