...
public partial class WeaponData : ItemData
{
    ...
    [Export] public int DamageDiceCount = 1;
    [Export] public int DamageDiceSides = 8;
    ...
    [Export] public int RangeCells = 1;       // 射程/触及范围
    [Export] public bool IsLongbow;           // 长弓：高AP消耗
    [Export] public bool IsCrossbow;          // 十字弩：高AP消耗 + 需要装填
    [Export] public bool IsThrowing;          // 投掷武器
    [Export] public int ThrowRange = 3;       // 投掷射程
    [Export] public int MaxAmmo = 0;          // 最大弹药/携带数 (针对投掷)
    [Export] public bool NeedsReload;         // 需要装填
    [Export] public int ApCost = 4;           // 攻击消耗 AP
    [Export] public int ReloadCost = 6;       // 装填消耗 AP
