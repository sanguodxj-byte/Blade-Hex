...
public partial class SpellData : Resource
{
    ...
    [Export] public string SpellName = "未命名法术";
    ...
    [Export] public int RangeCells = 6;
    [Export] public SpellShape shape = SpellShape.Single;
    [Export] public int ShapeSize = 1;
