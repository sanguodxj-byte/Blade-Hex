...
public partial class RaceData : Resource
{
    ...
    [Export] public string RaceName = "人类";
    ...
    // 种族特性描述
    [Export] public string TraitsDescription = "";

    // 招募难度系数（1.0=标准，越高越难）
    [Export] public float RecruitmentDifficulty = 1.0f;
    ...
    private static RaceData CreateHalfElf() => new()
    {
        ...
        SuitableTendencies = ["圣骑士", "牧师", "游荡者", "法师"],
    };
}
