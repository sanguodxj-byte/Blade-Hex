...
public partial class GameSettings : RefCounted
{
    ...
    private const string SettingsPath = "user://sword_and_hex_settings.dat";
    ...
    [Export] public int ResolutionIndex = 0;
    ...
    [Export] public float AmbientVolume = 0.6f;
    ...
    [Export] public float GameSpeed = 2.0f;
    [Export] public bool AutoSave = true;
    [Export] public int AutoSaveInterval = 10;
    [Export] public float CombatAnimSpeed = 1.0f;
    [Export] public int CombatLogDetail = 1;
    [Export] public bool ShowDamageNumbers = true;
    [Export] public bool ShowCombatGrid = true;
    [Export] public bool ConfirmEndTurn = true;
    [Export] public bool ShowMinimap = true;
    ...
    [Export] public bool CameraEdgeScroll = true;
    [Export] public float EdgeScrollSpeed = 600.0f;
    ...
    public bool LoadFromFile()
    {
        ...
        {
            Deserialize((Godot.Collections.Dictionary)data);
            return true;
        }
        return false;
    }
