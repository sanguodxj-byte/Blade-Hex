...
public static class MoraleSystem
{
    ...
    public static MoraleEffects GetMoraleEffects(Unit unit)
    {
        ...
        return level switch
        {
            >= 20 => new MoraleEffects { CritBonus = 0.20f, FumbleRate = 0.0f, AcModifier = 0, Name = "高昂" },
            >= -19 => new MoraleEffects { CritBonus = 0.0f, FumbleRate = 0.0f, AcModifier = 0, Name = "正常" },
            >= -39 => new MoraleEffects { CritBonus = 0.0f, FumbleRate = 0.20f, AcModifier = 0, Name = "低落" },
            >= -59 => new MoraleEffects { CritBonus = 0.0f, FumbleRate = 0.40f, AcModifier = -2, Name = "崩溃" },
